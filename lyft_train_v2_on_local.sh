...
#python train_v2.py --gpu 0 --model frustum_pointnets_v1 --log_dir "./log_v1_test/" \
#                  --max_epoch 200 --batch_size 32 --decay_step 800000 \
#                  --decay_rate 0.5 --data_dir "/Users/kanhua/Downloads/3d-object-detection-for-autonomous-vehicles/artifacts"
